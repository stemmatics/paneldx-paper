...
\author[nchu]{Muhammad Umer Imran}
\ead{umer@3dex.com}

\address[nchu]{School of Medicine, Nanchang University, Nanchang, Jiangxi, China}

\begin{abstract}
A longitudinal dataset asserts that rows
...
\begin{tabular}{lrrl}
\toprule
Entity key & Baseline MAE & Baseline $R^2$ & Apparent conclusion \\
\midrule
Positional, as used & 0.4717 & 0.191 & The baseline is uninformative \\
Recovered & 0.0320 & 0.971 & The baseline beats the model 2.9-fold \\
\bottomrule
\end{tabular}
\end{table}
